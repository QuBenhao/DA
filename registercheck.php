<?php
    ...
    if($_POST['fullname']==null || $_POST['screenname']==null || $_POST['password']==null || $_POST['sex']==0){
        echo '<html><head><Script Language="JavaScript">alert("Input cannot be empty");</Script></head></html>' .
